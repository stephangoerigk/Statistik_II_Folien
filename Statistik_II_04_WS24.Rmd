...
Es wurde eine lineare Regression mit dem Prädiktor IQ und dem Kriterium Testleistung durchgeführt. Die Analyse ergab, dass IQ ein signifikanter Prädiktor für die Testleistung ist, $β$ = 0.12, $t$(18) = 3.83, $p$ = .001. Das Modell erklärte etwa 44.9% der Varianz der Testleistung, $R^2$ = .42, $F$(1,18) = 14.69, $p$ = .001.
...
>Es wurde eine lineare Regression mit dem Prädiktor IQ und dem Kriterium Testleistung durchgeführt. Die Analyse ergab, dass IQ ein signifikanter Prädiktor für die Testleistung ist, $β$ = 0.12, $t$(18) = 3.83, $p$ = .001. Das Modell erklärte etwa 44.9% der Varianz der Testleistung.
