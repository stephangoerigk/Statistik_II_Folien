---
title: "Einheit 11"
subtitle: "Verfahren für Nominaldaten (2)"
...
#### Logistische Regression – Lösung: die logistische Funktion

.center[
```{r eval = TRUE, echo = F, out.width = "900px"}
knitr::include_graphics("bilder/logit_transform.svg")
```
]
...
* Sie ist nun auf den Wertebereich zwischen 0 und 1 begrenzt
...
>* Falls das Ereignis $Y_i = 0$ wahrscheinlicher ist als das Ereignis $Y_i= 1$  $\rightarrow$ Odds < 1
...
#### Logistische Regression – Odds visualisiert

.center[
```{r eval = TRUE, echo = F, out.width = "820px"}
knitr::include_graphics("bilder/odds_balance.svg")
```
]
...
**Ermittlung der Odds für Y-Achsenabschnitt $(a)$**
...
* Empathie (zentriert) = 0 ist nun der Durchschnittswert der Stichprobe (nur $a$ ändert sich, $\beta$ bleibt unverändert)
...
* Mithilfe der **logistischen Funktion** (aka. sigmoide Funktion) wird Wertebereich zwischen 0 und 1 begrenzt (Wahrscheinlichkeiten).
