...
##### `r data.frame(readxl::read_excel("Modul Quantitative Methoden II_Termine.xlsx"))$Datum[7]` | Prof. Dr. Stephan Goerigk
...
* $b_{Konfrontativ|Erfahrung=neidrig}$ und $b_{Konfrontativ|Erfahrung=mittel}$ unterscheiden sich nicht signifikant $(p = .065)$
