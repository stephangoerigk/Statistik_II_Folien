...
$$\chi^2_{emp} = \sum\limits _{i=1}^{k}\sum\limits _{j=1}^{l}\frac{(f_{bij} - f_{eij})^2}{f_{eij}} = \frac{(36 - 24.5)^2}{24.5} + \frac{(13 - 25.5)^2}{24.5} +\frac{(14 - 25.5)^2}{24.5} + \frac{(37 - 25.5)^2}{25.5}=21.17$$
mit:
