---
title: "Einheit 5"
subtitle: "Mehrfaktorielle ANOVA"
...
#### Struktur eines zweifaktoriellen Designs

.center[
```{r eval = TRUE, echo = F, out.width = "90%"}
knitr::include_graphics("bilder/faktoriell_design.svg")
```
]
...
* Ist er ausreichend unwahrscheinlich (p<.05) wird die $H_0$ verworfen
  ...
  $\rightarrow$ Der Interaktionseffekt ist signifikant (hat einen systematischen Einfluss auf die AV, der über reine Haupteffekte hinaus geht)
