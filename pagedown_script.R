...
for (i in 1:12) {
  ...
  current_input <- file.path(my_local_wd, paste0("Statistik_II_", nr_string, ".html"))
  output_name <- file.path(my_local_wd, paste0("QMII_Einheit_", i, ".pdf"))
...
pagedown::chrome_print("Statistik_II_09.html", timeout = 120)
